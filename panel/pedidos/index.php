    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">Troramundos Store</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            ...
            <li>
              <a href="../peliculas/index.php" class="btn">Zapatos</a>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="../cerrar_session.php">Logout</a></li>
                </ul>
            </li>
          </ul>
                ...
                <table class="table table-bordered">
                  ...
                  <tbody> 
                    ...
                    <tr>
                      ...
                      <td><?php print $item['total']?> LPS</td>
